...
- Built-in name/DOB/gender/nationality create form, then hands off to the active framework's character creation flow (or a custom appearance editor for standalone/custom providers)
